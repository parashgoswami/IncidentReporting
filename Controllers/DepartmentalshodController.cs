...
{
    public class DepartmentalshodController : Controller
    {
        ...
        public DepartmentalshodController(ILogger<NearmissesController> logger, UserManager<ApplicationUser> userManager, IncidentReportingContext context)
        {
            _logger = logger;
        ...
        public async Task<IActionResult> GetList()
        {
            ...
            var data = from m in _context.Departmental
                       select m;
